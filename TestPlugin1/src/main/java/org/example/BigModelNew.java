...
import static com.meteor.wechatbc.Main.weChatClient;

public class BigModelNew extends WebSocketListener implements Listener {
    ...
    public static final String appid = "8c3c4311";
    public static final String apiSecret = "Yzc5YjNlZGYyMDUxMzAzMzVmYTUwMWU1";
    public static final String apiKey = "1d9b160eed539754e908a68b0e397083";

    public static List<RoleContent> historyList=new ArrayList<>(); // 对话历史存储集合
    private static String lastFromUserName;
    public static String totalAnswer=""; // 大模型的答案汇总
    public static String totalAnswer2="";
...
//        System.out.print("大模型：");
    ...
    public void onMessage(WebSocket webSocket, String text) {
        ...
        if (myJsonParse.header.status == 2) {
            ...
            totalFlag = true;
            // 发送消息给最近一次收到消息的发送者
            if (lastFromUserName != null) {
                weChatClient.getWeChatCore().getHttpAPI().sendMessage(lastFromUserName, totalAnswer);
            }
        }
    }
    ...
    public BigModelNew(PluginMain pluginMain){
    ...
    public void onReceiveMessage(ReceiveMessageEvent receiveMessageEvent) {
        ...
        lastFromUserName = message.getFromUserName();



        if (content.contains("霏宇")) {
            NewQuestion = content.replace("霏宇", "");
            // 构建鉴权url
            String authUrl = null;
            try {
